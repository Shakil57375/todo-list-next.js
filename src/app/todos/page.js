...
const Todos = () => {
  ...
  const deleteTodo = (title) => {
    console.log(title);
    let newTodos = createdTodos.filter((item) => {
    ...
    <section className="text-gray-600 body-font">
      <div className="px-5 py-24 mx-auto">
        <div className="w-full mb-20">
          <div className=" w-full mx-auto mb-6 lg:mb-0">
            <h1 className="sm:text-3xl text-2xl text-center font-medium title-font mb-2 text-gray-900">
              Your Todos
            </h1>
            <p className="text-center font-medium ">Your todos</p>
          </div>
        </div>
        <div className="grid lg:grid-cols-3 grid-cols-1">
          {createdTodos.map((todo) => {
            return (
              <div key={todo.title} className="w-full">
                <div className="p-4">
                  <div className="bg-gray-100 p-6 rounded-lg">
                    ...
                    <div className="flex gap-4 mt-5 w-full mx-auto">
                      <svg
